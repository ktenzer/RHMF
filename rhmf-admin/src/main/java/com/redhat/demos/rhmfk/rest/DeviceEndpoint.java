...
import com.redhat.demos.rhmfk.model.Device;
...
public class DeviceEndpoint {
	...
	public Response create(Device entity) {
		...
		return Response.created(
				UriBuilder.fromResource(DeviceEndpoint.class)
	...
	public Response findById(@PathParam("id") Long id) {
		TypedQuery<Device> findByIdQuery = em
				.createQuery(
						"SELECT DISTINCT d FROM Device d WHERE d.id = :entityId ORDER BY d.id",
						Device.class);
	...
	@GET
	@Produces("application/json")
	public List<Device> listAll(@QueryParam("start") Integer startPosition,
